...
type PurchaseRecordStatus = "ACTIVE" | "VOIDED";

interface PurchaseStatusFieldProps {
  source?: string;
  record?: Record<string, any>;
  label?: string;
}

export const PurchaseStatusField: React.FC<PurchaseStatusFieldProps> = ({
  source = "recordStatus",
  record: recordProp,
}) => {
  ...
  const status = statusValue
    ? (String(statusValue).toUpperCase() as PurchaseRecordStatus)
    : undefined;
