...
interface APSummaryQueryControlsProps {
  ...
  onQuery: () => void;
  onQuickSelectQuery?: (params: APSummaryQueryParams) => void;
  onRefresh: () => void;
  onExport: () => void;
...
export const APSummaryQueryControls = ({
  queryMode,
  onQueryModeChange,
  period,
  onPeriodChange,
  ...
  canQuery = false,
  error,
}: APSummaryQueryControlsProps) => {
  const MAX_PERIODS = 12;

  // 快速選擇處理
  const handleQuickSelect = (params: APSummaryQueryParams) => {
    // 1. 多月份趨勢
                ...
                <Box>
                  ...
                  <DatePicker
                    ...
                    slotProps={{
                      textField: {
                        fullWidth: true,
                        helperText: "例如：查詢截至今日尚未支付給廠商的進貨款項總額"
                      },
                    }}
                  />
                </Box>
