...
export const ExpenseCategoryStatusToggle = () => {
  // Hooks 一律放最上面
  const record = useRecordContext<ExpenseCategoryRow>();
  ...
  const handleToggle = async () => {
    ...
    try {
      await dataProvider.update("expense_categories", {
        id: record.id,
        data: {},
        meta: {
      ...
      notify(isActive ? "費用分類已停用" : "費用分類已啟用", {
        type: "success",
      });
